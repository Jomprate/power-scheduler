...
class SystemdServiceScheduleTests(unittest.TestCase):
    ...
    def test_schedule_user_unit_success(self, mock_run) -> None:
    ...
    @patch("services.systemd_service.run_command")
    def test_schedule_system_unit_success(self, mock_run) -> None:
        mock_run.return_value = Mock(returncode=0, stdout="started", stderr="")
        params = SystemdScheduleParams(
    ...
    @patch("services.systemd_service.run_command")
    def test_schedule_polkit_error(self, mock_run) -> None:
    ...
    @patch("services.systemd_service.run_command")
    def test_schedule_generic_failure_includes_stderr(self, mock_run) -> None:
